 ...
 *
 * v2.2.13: 27/11/2020				Rename "rank" column to "pos" in all tables to be compatible with MySQL 8.x
 ...
 * 
 * v2.2.20  20/09/2021				catch error when a relationship or connection has got no source or no target
