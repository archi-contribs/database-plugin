 ...
 */
public class DBTextFieldEditor extends FieldEditor {
	 ...
	 * @param parent the parent of the field editor's control
	 */
	public DBTextFieldEditor(String name, String labelText, int width, Composite parent) {
	 ...
	 * @param parent the parent of the field editor's control
	 */
	public DBTextFieldEditor(String name, String labelText, Composite parent) {
