...
public class DBDatabaseEntry {
	...
	public String getServer() {
		DBPlugin.debug(DebugLevel.SecondaryMethod, "+Entering DBDatabaseEntry.getServer() -> \""+server+"\"");
		return server;
	}
	...
	public static void getAllFromPreferenceStore(List<DBDatabaseEntry> databaseEntries) {
		...
		for (int line = 0; line <lines; line++) {
			...
			for (String prop: properties) {
				DBPlugin.debug(DebugLevel.Variable, "got property " + preferenceName+"_"+prop+"_"+String.valueOf(line) +" = " + store.getString(preferenceName+"_"+prop+"_"+String.valueOf(line)));
