...
public class DBProgressTabItem {
	...
	static final Color COLOR_RED = Display.getCurrent().getSystemColor(SWT.COLOR_RED);
	static final Color COLOR_BLACK = Display.getCurrent().getSystemColor(SWT.COLOR_BLACK);
	static final Color COLOR_GREEN = Display.getCurrent().getSystemColor(SWT.COLOR_DARK_GREEN);
	...
	DBProgressTabItem (TabFolder tabFolder, String _title) {
		...
		countMetadatas = DBPlugin.createLabel(composite, 10, 80, 75, 1, "", SWT.RIGHT);							countMetadatas.setData("name","Metadatas");
