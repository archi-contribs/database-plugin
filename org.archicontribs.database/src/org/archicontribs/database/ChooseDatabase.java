...
public class ChooseDatabase extends Dialog {
	 ...
	 * @param style
	 */
	public ChooseDatabase(/*Shell parent, int style*/) {
		...
		btnOk.addSelectionListener(new SelectionListener() {
			...
			public void widgetDefaultSelected(SelectionEvent e) {
				try {
					...
					DatabasePlugin.popup(Level.Error, "Cannot load 'org."+driver.getText().toLowerCase()+".Driver' driver.", ee);
					return;
				}
				...
				try {
					...
					DatabasePlugin.popup(Level.Error, "Cannot connect to the database.", ee);
					return;
				}
				saveValues();
	...
	private void saveValues() {
		...
		try {
			...
			DatabasePlugin.popup(Level.Error, "Cannot save preferences.", e);
			return;
		}
	}
}
