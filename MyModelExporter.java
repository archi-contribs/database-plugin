...
public class MyModelExporter implements IModelExporter {
	...
	private void exportDiagramModelArchimateObject(String parent, DiagramModelArchimateObject obj, int rank, int indent) throws SQLException {
		...
		DatabasePlugin.update(db, "INSERT INTO DiagramModelArchimateObject (id, parent, fillcolor, font, fontcolor, linecolor, linewidth, name, textAlignment, element, targetconnections, rank, indent)",
				obj.getId(), parent, obj.getFillColor(), obj.getFont(), obj.getFontColor(), obj.getLineColor(), obj.getLineWidth(), obj.getName(), obj.getTextAlignment(), obj.getArchimateElement().getId(), target, rank, indent);
